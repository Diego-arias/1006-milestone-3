...
### DIEGO: Neverthelles, this paper seems to be very interesting, as it uses audio recordings from courts to see if judges implicitly reveal their verdict leaning during
### DIEGO: oral arguments, even before arguments and deliberations are done
